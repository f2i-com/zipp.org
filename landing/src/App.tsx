...
function Playground() {
  ...
  return (
    <section className="playground-section" id="javascript-scratchpad">
      ...
      <p className="playground-build-note">Bundled engine: <a href={`${GITHUB_URL}/releases/tag/v0.0.16`} target="_blank" rel="noreferrer">ZIPP WASM v0.0.16</a>. Each run uses a disposable Worker with a host-enforced deadline. Repository updates do not swap the engine underneath your code.</p>
    </section>
  )
}
