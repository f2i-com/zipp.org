...
import init, { Engine, zippProfile } from "../playground-runtime/zipp_wasm.js?v=1926e3238fec1987";
...
const ready = init({ module_or_path: new URL("../playground-runtime/zipp_wasm_bg.wasm?v=1926e3238fec1987", import.meta.url) }).then(() => JSON.parse(zippProfile()));
