...
The [`v0.0.8` release](https://github.com/f2i-com/zipp.org/releases/tag/v0.0.8)
...
with `chmod +x zipp-0.0.8-x86_64-unknown-linux-gnu/zipp`.
...
#### Current v0.0.8 native confirmation

The clean default-feature v0.0.8 release binary at engine-source commit
...
#### Current v0.0.8 browser-WASM status

The committed v0.0.8 production module is 5,480,311 bytes raw, 1,825,812 at
...
We also attempted a direct, unscaled WASM run over the same current v0.0.8
normal 13 and hostile 17 sources used by the v0.0.8 Node/Bun/Deno reruns in
