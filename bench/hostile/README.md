...
[`w39_final_cleanenv_dirty_2026-08-25.json`](w39_final_cleanenv_dirty_2026-08-25.json):
...
The [final combined diagnostic](w30_combined_dirty_2026-08-25.json) also uses
...
isolation; see the [root security boundary](../../README.md#running-untrusted-scripts)
