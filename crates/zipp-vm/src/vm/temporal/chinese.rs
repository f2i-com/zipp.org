...
mod tests {
    ...
    fn leap_years(dangi: bool, lo: i64, hi: i64) -> Vec<i64> {
        (lo..hi).filter(|&y| year(dangi, y).n_months == 13).collect()
    }
    ...
    fn leap_month_ordinals_match_test262() {
        ...
        let chinese = [
            (1971, 6, 5), (1974, 5, 4), (1976, 9, 8), (1979, 7, 6), (1982, 5, 4),
            (1987, 7, 6), (1990, 6, 5), (1993, 4, 3), (1995, 9, 8), (1998, 6, 5),
            (2001, 5, 4), (2004, 3, 2), (2006, 8, 7), (2009, 6, 5), (2012, 5, 4),
            (2017, 7, 6), (2020, 5, 4), (2023, 3, 2), (2025, 7, 6), (2028, 6, 5),
            (2031, 4, 3), (2036, 7, 6), (2039, 6, 5), (2042, 3, 2), (2044, 8, 7),
            (2047, 6, 5),
        ];
    ...
    fn new_year_matches_published_dates() {
        for (y, iso) in [
            (1900, (1900, 1, 31)), (1954, (1954, 2, 3)), (1971, (1971, 1, 27)),
            (1999, (1999, 2, 16)), (2000, (2000, 2, 5)), (2012, (2012, 1, 23)),
            (2020, (2020, 1, 25)), (2025, (2025, 1, 29)), (2027, (2027, 2, 6)),
            (2030, (2030, 2, 3)),
        ] {
