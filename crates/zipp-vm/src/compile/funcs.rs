...
impl<'a> FnCompiler<'a> {
    pub(crate) fn func_decl(&mut self, f: &ox::Function) -> R<()> {
    ...
    pub(crate) fn func_decl_inner(&mut self, f: &ox::Function, do_sync: bool) -> R<()> {
    ...
    pub(crate) fn class_decl(&mut self, class: &ox::Class) -> R<()> {
    ...
    pub(crate) fn build_class_into(&mut self, class: &ox::Class, cls: Reg, name: Option<&str>) -> R<()> {
    ...
    pub(crate) fn class_expr(&mut self, class: &ox::Class, dst: Reg, name: Option<&str>) -> R<Reg> {
    ...
    pub(crate) fn stash_child_with_shadows(&mut self, bound: &[String], body: &[ox::Statement]) {
    ...
    pub(crate) fn compile_func_expr(&mut self, name: Option<String>, f: &ox::Function) -> R<(u32, bool)> {
    ...
    pub(crate) fn compile_arrow(&mut self, a: &ox::ArrowFunctionExpression, name: &str) -> R<(u32, bool)> {
