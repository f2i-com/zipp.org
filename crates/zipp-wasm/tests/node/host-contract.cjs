...
eq("symbol names", names, ["addPerson", "best", "buildGrid", "bump", "fetchIt", "grid", "people", "probeBridgeLimit", "probeForbidden", "save", "score", "settings", "softn", "spoofBudgetError", "syncInfo", "_init", "window", "navigator", "host"].sort());
...
ok("synchronous bridge arguments have a byte cap", bridgeLimitErr.includes("host bridge arguments exceed"), bridgeLimitErr);
